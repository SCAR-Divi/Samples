...
// -
// Wrappers for the SCAR export API, if you know what you're doing it might
// be better to use the export API directly. The export API is located in
// SCARLibSetup.pas. Not all exported functions wrapped in this file either.
// -
